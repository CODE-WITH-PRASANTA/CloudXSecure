...
const BackupCont = () => {
  ...
  return (
    <div className="backup-cont">
      ...
      {/* TITLE */}
      <h2 className="backup-cont__title">
      ...
      <div className="backup-cont__cards">
        ...
        <div className="backup-cont__card">
          ...
          <ul className="backup-cont__list">
            <li><span className="backup-cont__arrow">→</span> Success Stories</li>
            <li><span className="backup-cont__arrow">→</span> Success service</li>
            <li><span className="backup-cont__arrow">→</span> Success store</li>
          </ul>
        </div>

        {/* RIGHT CARD */}
        <div className="backup-cont__card backup-cont__card--highlight">
          <img src={iconImg} alt="icon" className="backup-cont__customIcon" />
      ...
      <div className="backup-cont__faq">
        ...
        {[0, 1, 2].map((item, i) => (
          <div key={i} className="backup-cont__faqItem">
            ...
            <div
              className={`backup-cont__faqBody ${
                active === i ? "open" : ""
              }`}
            >
              <p>
