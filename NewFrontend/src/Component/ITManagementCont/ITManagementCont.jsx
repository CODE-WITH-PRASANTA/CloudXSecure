      ...
      <div className="itm__cards">
        ...
        <div className="itm__card">
          ...
          <ul className="itm__list">
            <li><span className="itm__arrow">→</span> Success Stories</li>
            <li><span className="itm__arrow">→</span> Success service</li>
            <li><span className="itm__arrow">→</span> Success store</li>
          </ul>
        </div>
        ...
        {[0, 1, 2].map((item, i) => (
          <div key={i} className="itm__faqItem">
            ...
            >
              ...
              <FiPlus
                className={`itm__plus ${active === i ? "active" : ""}`}
              />
            </div>

            <div
              className={`itm__faqBody ${
                active === i ? "open" : ""
              }`}
            >
              <p>
