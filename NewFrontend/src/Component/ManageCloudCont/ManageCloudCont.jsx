      ...
      <div className="mcc__cards">
        ...
        <div className="mcc__card">
          ...
          <ul className="mcc__list">
            <li><span className="mcc__arrow">→</span> Success Stories</li>
            <li><span className="mcc__arrow">→</span> Success service</li>
            <li><span className="mcc__arrow">→</span> Success store</li>
          </ul>
        </div>
        ...
        {[0, 1, 2].map((item, i) => (
          <div key={i} className="mcc__faqItem">
            ...
            >
              ...
              <FiPlus
                className={`mcc__plus ${active === i ? "active" : ""}`}
              />
            </div>

            <div
              className={`mcc__faqBody ${
                active === i ? "open" : ""
              }`}
            >
              <p>
