...
const DevAutoCont = () => {
  ...
  return (
    <div className="dev-auto-sdc">
      ...
      {/* TITLE */}
      <h2 className="dev-auto-sdc__title">
      ...
      <div className="dev-auto-sdc__cards">
        ...
        <div className="dev-auto-sdc__card">
          ...
          <ul className="dev-auto-sdc__list">
            <li><span className="dev-auto-sdc__arrow">→</span> Success Stories</li>
            <li><span className="dev-auto-sdc__arrow">→</span> Success service</li>
            <li><span className="dev-auto-sdc__arrow">→</span> Success store</li>
          </ul>
        </div>

        {/* RIGHT CARD */}
        <div className="dev-auto-sdc__card dev-auto-sdc__card--highlight">
          <img src={iconImg} alt="icon" className="dev-auto-sdc__customIcon" />
      ...
      <div className="dev-auto-sdc__faq">
        ...
        {[0, 1, 2].map((item, i) => (
          <div key={i} className="dev-auto-sdc__faqItem">
            ...
            <div
              className={`dev-auto-sdc__faqBody ${
                active === i ? "open" : ""
              }`}
            >
              <p>
