...
import "./OurServicesBreadcrum.css";
...
const Breadcrumb = () => {
  ...
  return (
    <section className="blogbreadcrumb-wrapper" ref={wrapperRef}>
      <canvas ref={canvasRef} className="stars-canvas" />

      <div className="blogbreadcrumb-inner">
        {/* TEXT */}
        <div className="blogbreadcrumb-content">
          <h1>Our Services</h1>
          <p>
            Home <span>&gt;</span> Services<span>&gt;</span>Our Services
          </p>
        </div>
