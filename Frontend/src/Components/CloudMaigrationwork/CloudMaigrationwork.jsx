  ...
  const steps = [
    {
      ...
      text: "Select the cloud or development solution that fits your goals.",
    ...
    },
    {
      ...
      text: "We analyze your needs and create a clear technical roadmap.",
      icon: <FaTasks />,
      pos: "down",
    },
    {
      ...
      text: "Collaborate with our experts to refine strategy and scope.",
      icon: <FaUsersCog />,
      pos: "up",
    },
    {
      ...
      text: "We deliver secure, scalable, and optimized digital solutions.",
      icon: <FaHandshake />,
      pos: "down",
    },
  ];
