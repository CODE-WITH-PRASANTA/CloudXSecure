...
import hand from "../../assets/elements16.png";
import circles from "../../assets/elements5.png";
import orbits from "../../assets/elements4.png";
import moon from "../../assets/elements1.png";
...
const Breadcrumb = () => {
  ...
  return (
    <section className="breadcrumb-wrapper" ref={wrapperRef}>
